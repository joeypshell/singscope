...
2. Implement MIDI/manual/monophonic targets and the reusable YIN pitch-analysis pipeline.
...
6. Verify pure DSP, components, mobile WebKit, iOS Simulator Safari, deployment, and physical iPhone.
