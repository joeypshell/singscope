...
| Physical checklist                | Current public iOS on real hardware                              | Shipping Safari/Home Screen microphone routes, direct melody capture, practice recording, storage, export, accessibility, and the release acceptance described in `iphone-acceptance.md` | Compatibility on every older OS or secondary platform                                         |
...
A green workflow and successful Pages deployment mean “automated gates passed.” They must not be described as “iPhone accepted.” That label requires the completed physical checklist—including **Record melody** in Safari and installed Home Screen mode—with device model, iOS build, app commit SHA, audio route, tester, and recorded failures or approved limitations.
